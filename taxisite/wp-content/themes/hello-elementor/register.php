            ...
            <section>
                <div class="reglog-form">
                    ...
                    <div class="alert alert-success mt-4 form-message" role="alert">
                        <p class="m-0">Thanks for taking the time to apply. We know your time is valuable and we are looking forward to speaking with you. Give just a moment to review your information and we will be right back with you. Thanks and talk with you shortly.</p>
                    </div>
                    <?php } ?>
